...
<svelte:head>
    <title>Error {status} - Auction Items</title>
</svelte:head>
    ...
    <main class="container error-main">
        <div class="error-content">
            ...
            <div class="error-details">
                <p class="error-message">
                    {status === 404 
                        ...
                        : "We encountered an error while loading the auction items. Please try again."
                    }
                </p>
            ...
            <div class="error-actions">
                <button class="btn btn-primary" on:click={goBackToAuctions}>
                    Back to Auctions
                </button>
